...
export const IndicatorWrapper: React.FC<IndicatorWrapperProps> = ({
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-3 md:p-4 overflow-visible">

      <div className="relative min-h-[300px] w-full border border-gray-50 rounded-xl bg-gray-50/30">
        {loading ? (
      ...
      <div className="mt-2 p-3 bg-gray-50 border-l-4 border-gray-900 rounded-r-xl">
